...
class Index extends AbstractTemplate
{
    ...
    {
        /** @var \M2E\Temu\Block\Adminhtml\Mapping\Tabs $tabsBlock */
        $tabsBlock = $this->getLayout()->createBlock(
            \M2E\Temu\Block\Adminhtml\Mapping\Tabs::class,
        );
        ...
        $this->addContent($this->getLayout()->createBlock(\M2E\Temu\Block\Adminhtml\Mapping::class));
