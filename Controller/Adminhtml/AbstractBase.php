...
abstract class AbstractBase extends Action
{
    ...
    public const MESSAGE_IDENTIFIER = 'temu_messages';
    public const GLOBAL_MESSAGES_GROUP = 'temu_global_messages_group';
    ...
    protected \M2E\Temu\Block\Adminhtml\Magento\Renderer\CssRenderer $cssRenderer;
    ...
    {
        /** @var \M2E\Temu\Controller\Adminhtml\Context $context */
        $context = \Magento\Framework\App\ObjectManager::getInstance()->get(
            \M2E\Temu\Controller\Adminhtml\Context::class
        );
    ...
    public function dispatch(\Magento\Framework\App\RequestInterface $request)
    {
        ...
        try {
            ...
            /** @var \M2E\Temu\Model\Module\Environment $moduleEnv */
            $moduleEnv = $this->_objectManager->get(\M2E\Temu\Model\Module\Environment::class);
            if ($moduleEnv->isDevelopmentEnvironment()) {
                throw $exception;
            }
    ...
    {
        /** @var \M2E\Temu\Helper\Module\Maintenance $maintenanceModule */
        $maintenanceModule = $this->_objectManager->get(\M2E\Temu\Helper\Module\Maintenance::class);
    ...
    protected function initResultPage(): void
    {
        ...
        if ($this->getLayoutType() !== self::LAYOUT_BLANK) {
            ...
            $this->getResultPage()->setActiveMenu(\M2E\Temu\Helper\View\Temu::MENU_ROOT_NODE_NICK);
        }
    }
    ...
    protected function addLeft(\Magento\Framework\View\Element\AbstractBlock $block)
    {
        if ($this->getLayoutType() != self::LAYOUT_TWO_COLUMNS) {
            throw new \M2E\Temu\Model\Exception\Logic('Add left can not be used for non two column layout');
        }
    ...
    {
        $this->getResultPage()->getConfig()->addPageAsset("M2E_Temu::css/$file");
    }
    ...
    protected function appendGeneralBlock()
    {
        ...
        if (!$this->getLayout()->hasElement('m2e.temu.general')) { // view/layout/m2e_temu_general_handler.xml
            $generalBlock = $this->getLayout()->createBlock(\M2E\Temu\Block\Adminhtml\General::class);
    ...
    protected function setPageHelpLink($link)
    {
        ...
        $helpLinkBlock = $this->getLayout()->createBlock(\M2E\Temu\Block\Adminhtml\PageHelpLink::class)->setData([
            'page_help_link' => $link,
        ]);

        $pageTitleBlock->setTitleClass('Temu-page-title');
        $pageTitleBlock->setChild('Temu.page.help.block', $helpLinkBlock);
    }
    ...
    protected function getViewHelper(): \M2E\Temu\Helper\View
    {
        return $this->_objectManager->get(\M2E\Temu\Helper\View::class);
    }
}
