...
namespace M2E\Temu\Controller\Adminhtml\Settings\LogsClearing;

class Save extends \M2E\Temu\Controller\Adminhtml\AbstractBase
{
    private \M2E\Temu\Model\Log\Clearing $clearing;

    public function __construct(\M2E\Temu\Model\Log\Clearing $clearing)
    {
        parent::__construct();
