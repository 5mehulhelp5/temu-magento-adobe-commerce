...
class Complete extends \M2E\Temu\Controller\Adminhtml\AbstractListing
{
    ...
    private \M2E\Temu\Model\Listing\Wizard\CompleteProcessor $completeProcessor;

    public function __construct(
        \M2E\Temu\Model\Listing\Wizard\ManagerFactory $wizardManagerFactory,
        \M2E\Temu\Model\Listing\Wizard\CompleteProcessor $completeProcessor,
    ...
    public function execute()
    {
        ...
        $wizardManager->completeStep(
            \M2E\Temu\Model\Listing\Wizard\StepDeclarationCollectionFactory::STEP_REVIEW,
        );
