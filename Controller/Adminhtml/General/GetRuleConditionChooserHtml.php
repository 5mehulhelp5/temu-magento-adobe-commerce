...
class GetRuleConditionChooserHtml extends \M2E\Temu\Controller\Adminhtml\AbstractGeneral
{
        ...
        switch ($request->getParam('attribute')) {
            case 'sku':
                $block = $this->getLayout()->createBlock(
                    \M2E\Temu\Block\Adminhtml\Magento\Product\Rule\Chooser\Sku::class,
