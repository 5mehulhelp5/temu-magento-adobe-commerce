...
class GetCreateAttributeHtmlPopup extends \M2E\Temu\Controller\Adminhtml\AbstractGeneral
{
    public function execute()
    {
        $post = $this->getRequest()->getPostValue();

        /** @var \M2E\Temu\Block\Adminhtml\General\CreateAttribute $block */
        $block = $this->getLayout()->createBlock(\M2E\Temu\Block\Adminhtml\General\CreateAttribute::class);
