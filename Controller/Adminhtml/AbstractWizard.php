...
abstract class AbstractWizard extends AbstractMain
{
    ...
    {
        $this->setStatus(\M2E\Temu\Helper\Module\Wizard::STATUS_COMPLETED);
    ...
    {
        return $this->getLayout()->createBlock(\M2E\Temu\Block\Adminhtml\Wizard\Congratulation::class);
    }
    ...
    protected function installationAction()
    {
        ...
        if ($this->isNotStarted()) {
            $this->setStatus(\M2E\Temu\Helper\Module\Wizard::STATUS_ACTIVE);
        }
    ...
    protected function getWizardHelper(): \M2E\Temu\Helper\Module\Wizard
    {
    ...
    protected function setWizardStatusCompleted()
    {
        ...
        $this->wizardHelper->setStatus(
            \M2E\Temu\Helper\View\Temu::WIZARD_INSTALLATION_NICK,
            \M2E\Temu\Helper\Module\Wizard::STATUS_COMPLETED
        );
    }
}
