...
namespace M2E\Temu\Controller\Adminhtml\Wizard\Registration;

class CreateLicense extends \M2E\Temu\Controller\Adminhtml\Wizard\AbstractRegistration
{
    private \M2E\Temu\Model\Connector\License\Add\Processor $connectionProcessor;
    ...
    public function __construct(
        ...
        \M2E\Temu\Model\Connector\License\Add\Processor $connectionProcessor,
    ...
    public function execute()
    {
        ...
        try {
            $request = new \M2E\Temu\Model\Connector\License\Add\Request(
