...
class Refresh extends \M2E\Temu\Controller\Adminhtml\AbstractAccount
{
    private \M2E\Temu\Model\Account\Repository $accountRepository;
    private \M2E\Temu\Model\Account\Update $updateAccountModel;

    public function __construct(
        \M2E\Temu\Model\Account\Repository $accountRepository,
        \M2E\Temu\Model\Account\Update $updateAccountModel
    ) {
        parent::__construct();
