...
namespace M2E\Temu\Model\HealthStatus\Notification;
...
class Settings
{
    ...
    {
        return (int)$this->config->get('/health_status/notification/', 'mode');
    }
    ...
    {
        return $this->config->get('/health_status/notification/', 'email');
    }
    ...
    {
        return $this->config->get('/health_status/notification/', 'level');
    }
}
