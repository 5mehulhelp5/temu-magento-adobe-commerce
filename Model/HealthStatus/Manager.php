...
namespace M2E\Temu\Model\HealthStatus;
...
class Manager
{
    ...
    public function __construct(
        ...
        \M2E\Temu\Model\HealthStatus\Task\Result\SetFactory $resultSetFactory,
    ...
    public function doCheck(): Task\Result\Set
    {
        ...
        foreach ($this->getTasks() as $taskClass) {
            try {
                /** @var \M2E\Temu\Model\HealthStatus\Task\AbstractModel $taskObject */
    ...
    {
        return [
            \M2E\Temu\Model\HealthStatus\Task\Database\MysqlInfo\CrashedTables::class,
            \M2E\Temu\Model\HealthStatus\Task\Database\MysqlInfo\TablesStructure::class,
            \M2E\Temu\Model\HealthStatus\Task\Server\Status\SystemLogs::class,
            \M2E\Temu\Model\HealthStatus\Task\Orders\MagentoCreationFailed::class,
        ];
    }
}
