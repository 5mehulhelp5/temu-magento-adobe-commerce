...
abstract class ChangeProcessorAbstract extends \M2E\Temu\Model\Policy\ChangeProcessorAbstract
{
    ...
    protected function getInstructionsData(
        ...
        if ($diff->isListModeEnabled()) {
            ...
            if ($status === \M2E\Temu\Model\Product::STATUS_NOT_LISTED) {
                $priority = 30;
            }
        ...
        if ($diff->isRelistModeEnabled()) {
            ...
            if (
                $status === \M2E\Temu\Model\Product::STATUS_INACTIVE
            ) {
                $priority = 50;
            }
