...
class ChangeProcessor extends \M2E\Temu\Model\Policy\Synchronization\ChangeProcessorAbstract
{
    ...
    /**
     * @param \M2E\Temu\Model\Policy\Synchronization\Diff $diff
     */
    protected function getInstructionsData(
        ...
        /** @var \M2E\Temu\Model\Policy\Synchronization\Diff $diff */
        if ($diff->isReviseQtyEnabled()) {
            $data[] = [
                'type' => self::INSTRUCTION_TYPE_REVISE_QTY_ENABLED,
                'priority' => $status === \M2E\Temu\Model\Product::STATUS_LISTED ? 80 : 5,
            ];
        ...
        if ($diff->isRevisePriceEnabled()) {
            $data[] = [
                ...
                'priority' => $status === \M2E\Temu\Model\Product::STATUS_LISTED ? 60 : 5,
            ];
