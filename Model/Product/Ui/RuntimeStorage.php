...
namespace M2E\Temu\Model\Product\Ui;
...
class RuntimeStorage
{
    ...
    public function __construct(\M2E\Temu\Model\Product\Repository $repository)
    {
    ...
    public function findProduct(int $id): ?\M2E\Temu\Model\Product
    {
