...
class OptionsFinder
{
    private \M2E\Temu\Model\Magento\Product $magentoProduct;
     ...
     * @return $this
     */
    public function setProduct(\M2E\Temu\Model\Magento\Product $magentoProduct)
    {
    ...
    private function isNeedToReturnFirstOptionValues(): bool
    {
