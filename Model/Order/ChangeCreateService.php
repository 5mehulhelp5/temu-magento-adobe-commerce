...
{
    private \M2E\Temu\Model\Order\Change\Repository $repository;
    private \M2E\Temu\Model\Order\ChangeFactory $factory;

    public function __construct(
        \M2E\Temu\Model\Order\Change\Repository $repository,
    ...
    {
        if (!in_array($action, [Change::ACTION_UPDATE_SHIPPING])) {
