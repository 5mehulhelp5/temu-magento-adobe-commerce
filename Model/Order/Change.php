...
class Change extends \M2E\Temu\Model\ActiveRecord\AbstractModel
{
    ...
    {
        if (!in_array($action, [self::ACTION_UPDATE_SHIPPING])) {
    ...
    public function getOrderItemsForShipping(): array
    {
    ...
    {
        return $this->getParams()['magento_shipment_id'];
    }
