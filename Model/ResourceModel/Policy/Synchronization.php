...
class Synchronization extends \M2E\Temu\Model\ResourceModel\ActiveRecord\AbstractModel
{
    ...
    {
        $this->_init(
            \M2E\Temu\Helper\Module\Database\Tables::TABLE_NAME_TEMPLATE_SYNCHRONIZATION,
            self::COLUMN_ID,
        );
    }
}
