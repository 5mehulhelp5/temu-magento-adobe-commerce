...
namespace M2E\Temu\Model\ResourceModel\Tag\ListingProduct;

class Relation extends \M2E\Temu\Model\ResourceModel\ActiveRecord\AbstractModel
{
    ...
    {
        $this->_init(
            \M2E\Temu\Helper\Module\Database\Tables::TABLE_NAME_PRODUCT_TAG_RELATION,
            self::COLUMN_ID
        );
    }
