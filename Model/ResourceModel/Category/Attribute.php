...
class Attribute extends \M2E\Temu\Model\ResourceModel\ActiveRecord\AbstractModel
{
    ...
    {
        $this->_init(
            \M2E\Temu\Helper\Module\Database\Tables::TABLE_NAME_TEMPLATE_CATEGORY_ATTRIBUTES,
            self::COLUMN_ID
        );
    }
}
