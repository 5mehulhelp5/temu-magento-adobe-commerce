...
class Step extends \M2E\Temu\Model\ResourceModel\ActiveRecord\AbstractModel
{
    ...
    {
        $this->_init(\M2E\Temu\Helper\Module\Database\Tables::TABLE_NAME_LISTING_WIZARD_STEP, self::COLUMN_ID);
    }
}
