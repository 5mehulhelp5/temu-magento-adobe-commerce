...
class Wizard extends \M2E\Temu\Model\ResourceModel\ActiveRecord\AbstractModel
{
    ...
    {
        $this->_init(\M2E\Temu\Helper\Module\Database\Tables::TABLE_NAME_LISTING_WIZARD, self::COLUMN_ID);
    }
}
