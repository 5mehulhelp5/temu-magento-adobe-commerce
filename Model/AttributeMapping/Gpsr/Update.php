...
use M2E\Temu\Model\Category\Attribute;

class Update
{
    private \M2E\Temu\Model\AttributeMapping\Repository $attributeMappingRepository;
    private \M2E\Temu\Model\AttributeMapping\PairFactory $mappingFactory;

    public function __construct(
        \M2E\Temu\Model\AttributeMapping\Repository $attributeMappingRepository,
        \M2E\Temu\Model\AttributeMapping\PairFactory $mappingFactory
    ) {
    ...
    /**
     * @param \M2E\Temu\Model\AttributeMapping\Gpsr\Pair[]  $attributesMapping
     *
    ...
    {
        $result = [];
        $knownAttributes = \M2E\Temu\Model\AttributeMapping\Gpsr\Provider::getAllAttributesCodes();
