...
class CategoryModifier
{
    ...
    private \M2E\Temu\Model\ResourceModel\Category\Dictionary\CollectionFactory $templateCategoryCollectionFactory;
    private \M2E\Temu\Model\Template\Category\AffectedListingsProductsFactory $affectedListingsProductsFactory;
    private \M2E\Temu\Model\AttributeMapping\Gpsr\CategoryModifier\CategoryDiffStub $categoryDiffStub;
    ...
    public function __construct(
        \M2E\Temu\Model\ResourceModel\Category\Dictionary\CollectionFactory $templateCategoryCollectionFactory,
        \M2E\Temu\Model\Template\Category\AffectedListingsProductsFactory $affectedListingsProductsFactory,
        \M2E\Temu\Model\AttributeMapping\Gpsr\CategoryModifier\CategoryDiffStub $categoryDiffStub,
    ...
    /**
     * @param \M2E\Temu\Model\AttributeMapping\Gpsr\Pair[] $gpsrAttributes
     *
     * @return void
     */
     ...
     * @param int $fromId
     *
     * @return \M2E\Temu\Model\Template\Category[]
     */
    ...
    /**
     * @param \M2E\Temu\Model\Template\Category $category
     * @param \M2E\Temu\Model\AttributeMapping\Gpsr\Pair[] $gpsrAttributes
     *
     * @return void
     */
    private function processCategory(\M2E\Temu\Model\Template\Category $category, array $gpsrAttributes): bool
    {
     ...
     */
    private function getSpecificsByName(\M2E\Temu\Model\Template\Category $category): array
    {
        $result = [];
    ...
    private function createProductInstruction(\M2E\Temu\Model\Template\Category $category): void
    {
