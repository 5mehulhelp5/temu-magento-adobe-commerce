...
class Repository
{
    private \M2E\Temu\Model\ResourceModel\Tag $tagResource;
    ...
    /** @var \M2E\Temu\Model\ResourceModel\Tag\ListingProduct\Relation */
    ...
    public function __construct(
        ...
        \M2E\Temu\Model\ResourceModel\Tag\CollectionFactory $tagCollectionFactory,
        \M2E\Temu\Model\ResourceModel\Tag\ListingProduct\Relation $relationResource,
     ...
     * @param int[] $ids
     *
     * @return \M2E\Temu\Model\Tag\ListingProduct\Relation[]
     */
    public function findRelationsByProductIds(array $ids): array
    {
        $collection = $this->relationCollectionFactory->create();
        $collection->addFieldToFilter(
            \M2E\Temu\Model\ResourceModel\Tag\ListingProduct\Relation::COLUMN_LISTING_PRODUCT_ID,
            [
                'in' => array_unique($ids),
            ]
        );
        ...
        $result = [];
        /** @var \M2E\Temu\Model\Tag\ListingProduct\Relation $item */
    ...
    public function getTagEntitiesWithoutHasErrorsTag(): array
    {
        ...
        $collection->getSelect()->columns([
            'main_table.' . \M2E\Temu\Model\ResourceModel\Tag::COLUMN_ID,
            'main_table.' . \M2E\Temu\Model\ResourceModel\Tag::COLUMN_TEXT,
            'main_table.' . \M2E\Temu\Model\ResourceModel\Tag::COLUMN_ERROR_CODE,
            'main_table.' . \M2E\Temu\Model\ResourceModel\Tag::COLUMN_CREATE_DATE,
        ]);

        $collection->getSelect()->where(
            \M2E\Temu\Model\ResourceModel\Tag::COLUMN_ERROR_CODE . ' != ?',
            \M2E\Temu\Model\Tag::HAS_ERROR_ERROR_CODE
        );
