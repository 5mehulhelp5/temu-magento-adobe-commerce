...
class Dispatcher
{
    ...
    private \M2E\Temu\Model\Connector\Client\Single $serverConnector;

    public function __construct(
        \M2E\Temu\Helper\Module\Exception $helperException,
        \M2E\Temu\Model\Registry\Manager $registryManager,
        \Magento\Framework\ObjectManagerInterface $objectManager,
        \M2E\Temu\Model\Connector\Client\Single $serverConnector
    ) {
     ...
     *
     * @return \M2E\Temu\Model\Servicing\TaskInterface[]
     */
    ...
    private function getTaskModel(string $taskName): TaskInterface
    {
        ...
        /** @var \M2E\Temu\Model\Servicing\TaskInterface */
