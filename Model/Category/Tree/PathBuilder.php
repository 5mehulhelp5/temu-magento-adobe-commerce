...
class PathBuilder
{
    ...
    public function getPath(\M2E\Temu\Model\Category\Tree $treeItem): string
    {
    ...
    private function buildTitle(\M2E\Temu\Model\Category\Tree $treeItem): string
    {
        ...
        $titles = array_map(static function (\M2E\Temu\Model\Category\Tree $ancestor) {
    ...
    private function findInCache(\M2E\Temu\Model\Category\Tree $treeItem): ?string
    {
    ...
    private function setToCache(\M2E\Temu\Model\Category\Tree $treeItem, string $title): void
    {
        $this->cache->setValue($this->createCacheKey($treeItem), $title, [], self::CACHE_LIFETIME_ONE_HOUR);
    }

    private function createCacheKey(\M2E\Temu\Model\Category\Tree $treeItem): string
    {
