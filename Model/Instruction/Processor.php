...
class Processor
{
    ...
    private \M2E\Temu\Model\Instruction\Handler\InputFactory $handlerInputFactory;
    ...
    public function __construct(
        ...
        \M2E\Temu\Model\Instruction\Handler\InputFactory $handlerInputFactory,
    ...
    {
        $maxListingsProductsCount = (int)$this->configManager->get(
    ...
    /**
     * @param \M2E\Temu\Model\Product[] $listingsProductsById
     *
