...
namespace M2E\Temu\Model\Instruction;

use M2E\Temu\Model\ResourceModel\Instruction as InstructionResource;
...
class Repository
{
    ...
    private \M2E\Temu\Model\ResourceModel\Product\Lock $productLockResource;
    ...
    public function __construct(
        ...
        \M2E\Temu\Model\ResourceModel\Product\Lock $productLockResource
    ) {
    ...
    public function create(\M2E\Temu\Model\Instruction $instruction): void
    {
        $instruction->save();
    }
    ...
    public function createMultiple(array $batchData): void
    {
        ...
        foreach ($batchData as $index => $instructionData) {
            ...
            // {listing_product_id:int, type: string, initiator: string, priority: int, skip_until?:\DateTime}
            $insertData[] = [
    ...
    public function findListingProductIdsByPriority(int $limit, ?\DateTime $excludeUntil): array
    {
        ...
        $joinCondition = sprintf(
            ...
            \M2E\Temu\Model\ResourceModel\Product\Lock::COLUMN_PRODUCT_ID
        );
        ...
        $collection->getSelect()->where(sprintf('pl.%s IS NULL', \M2E\Temu\Model\ResourceModel\Product\Lock::COLUMN_ID));
