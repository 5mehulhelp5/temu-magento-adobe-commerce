...
use M2E\Temu\Model\ResourceModel\Synchronization\Log as SyncLogResource;
...
class Log extends \M2E\Temu\Model\Log\AbstractModel
{
    ...
    public const _TASK_LISTINGS = 'M2E Temu Connect Listings';
    ...
    {
        parent::_construct();
        $this->_init(\M2E\Temu\Model\ResourceModel\Synchronization\Log::class);
    }
