...
class Create
{
    ...
    /** @var \M2E\Temu\Model\Listing\Wizard\StepFactory */
    ...
    /** @var \M2E\Temu\Model\Listing\Wizard\DeleteService */
    private DeleteService $deleteService;

    public function __construct(
        Repository $wizardRepository,
        \M2E\Temu\Model\Listing\WizardFactory $wizardFactory,
        \M2E\Temu\Model\Listing\Wizard\StepFactory $stepFactory,
        StepDeclarationCollectionFactory $stepDeclarationCollectionFactory,
        \M2E\Temu\Model\Listing\Wizard\DeleteService $deleteService
    ) {
    ...
    public function process(\M2E\Temu\Model\Listing $listing, string $type): \M2E\Temu\Model\Listing\Wizard
    {
        \M2E\Temu\Model\Listing\Wizard::validateType($type);
