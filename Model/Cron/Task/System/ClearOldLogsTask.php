...
namespace M2E\Temu\Model\Cron\Task\System;

class ClearOldLogsTask extends \M2E\Temu\Model\Cron\AbstractTask
{
    ...
    private \M2E\Temu\Model\Log\Clearing $clearing;
    private \M2E\Temu\Model\OperationHistory\Repository $operationHistoryRepository;
    private \M2E\Temu\Model\Log\System\Repository $systemLogRepository;

    public function __construct(
        \M2E\Temu\Model\Log\Clearing $clearing,
        \M2E\Temu\Model\Log\System\Repository $systemLogRepository,
        \M2E\Temu\Model\OperationHistory\Repository $operationHistoryRepository,
    ...
    {
        $this->clearing->clearOldRecords(\M2E\Temu\Model\Log\Clearing::LOG_LISTINGS);
        $this->clearing->clearOldRecords(\M2E\Temu\Model\Log\Clearing::LOG_SYNCHRONIZATIONS);
        $this->clearing->clearOldRecords(\M2E\Temu\Model\Log\Clearing::LOG_ORDERS);
