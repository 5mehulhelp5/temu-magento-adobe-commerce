...
abstract class AbstractRunner
{
    ...
    private \M2E\Temu\Model\Cron\OperationHistory $operationHistory;
    private \M2E\Temu\Model\Lock\Transactional\ManagerFactory $lockTransactionManagerFactory;
    ...
    private \M2E\Temu\Model\Cron\OperationHistoryFactory $operationHistoryFactory;
    private \M2E\Temu\Model\Cron\Strategy $strategy;
    ...
    protected function canProcess(): bool
    {
        ...
        if ($this->config->get('/cron/' . $this->getNick() . '/', 'disabled')) {
            return false;
        }
    ...
    public function getOperationHistory(): \M2E\Temu\Model\Cron\OperationHistory
    {
