...
namespace M2E\Temu\Model\Processing\ProcessResult;
...
class Partial
{
    ...
    private \M2E\Temu\Model\Processing\ResultHandlerFactory $resultHandlerFactory;
    private \M2E\Temu\Helper\Module\Exception $exceptionHelper;
    private \M2E\Temu\Model\Processing\LockManagerFactory $lockManagerFactory;

    public function __construct(
        \M2E\Temu\Model\Processing\Repository $repository,
        \M2E\Temu\Model\Processing\ResultHandlerFactory $resultHandlerFactory,
    ...
    public function processExpired(): void
    {
        foreach ($this->repository->findPartialTypeExpired() as $processing) {
            try {
                ...
                /** @var \M2E\Temu\Model\Processing\PartialResultHandlerInterface $handler */
