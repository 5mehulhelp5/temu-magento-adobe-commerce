...
class ResultHandlerFactory
{
    ...
    public function create(string $nick): \M2E\Temu\Model\Processing\SingleResultHandlerInterface
    {
        if (!$this->resultHandlerCollection->has($nick)) {
            throw new \M2E\Temu\Model\Exception\Logic("Processing handler '$nick' not found.");
        }
