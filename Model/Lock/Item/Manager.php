...
class Manager
{
    ...
    private string $nick;
    private \M2E\Temu\Model\Lock\ItemFactory $lockItemFactory;
    private ManagerFactory $lockItemManagerFactory;
    /** @var \M2E\Temu\Model\Lock\Item\Repository */
    private Repository $repository;

    public function __construct(
        string $nick,
        \M2E\Temu\Model\Lock\Item\ManagerFactory $lockItemManagerFactory,
        \M2E\Temu\Model\Lock\ItemFactory $lockItemFactory,
        \M2E\Temu\Model\Lock\Item\Repository $repository
    ) {
        $this->nick = $nick;
    ...
    private function getLockItemObject(): ?\M2E\Temu\Model\Lock\Item
    {
