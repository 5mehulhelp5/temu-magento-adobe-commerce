...
class Manager
{
    ...
    /** @var \M2E\Temu\Model\Lock\Transactional\Repository */
    private Repository $repository;
    private \M2E\Temu\Model\Lock\TransactionalFactory $lockFactory;

    public function __construct(
        string $nick,
        Repository $repository,
        \M2E\Temu\Model\Lock\TransactionalFactory $lockFactory
    ) {
        $this->nick = $nick;
