...
namespace M2E\Temu\Model\Dashboard\Sales;

class Definition implements \M2E\Core\Model\Dashboard\Sales\DefinitionInterface
{
    private \M2E\Temu\Model\Dashboard\Sales\DataProvider $dataProvider;

    public function __construct(
        \M2E\Temu\Model\Dashboard\Sales\DataProvider $dataProvider
    ) {
