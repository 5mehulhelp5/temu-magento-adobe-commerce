...
class Combine extends AbstractModel
{
    ...
    private \M2E\Temu\Model\Magento\Product\Rule\Condition\ProductFactory $ruleConditionProductFactory;
    ...
    protected function getProductOptions()
    {
        ...
        return $this->getOptions(
            \M2E\Temu\Model\Magento\Product\Rule\Condition\Product::class,
            $attributes
        );
    }
    ...
    {
        return \M2E\Temu\Model\Magento\Product\Rule\Condition\AbstractModel::VALUE_ELEMENT_TYPE_TEXT;
    }
        ...
        if (!empty($arr[$key]) && is_array($arr[$key])) {
            foreach ($arr[$key] as $condArr) {
                try {
                    ...
                    if ($cond) {
                        if ($cond instanceof \M2E\Temu\Model\Magento\Product\Rule\Condition\Combine) {
