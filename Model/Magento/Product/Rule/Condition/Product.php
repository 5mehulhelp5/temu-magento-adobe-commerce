...
namespace M2E\Temu\Model\Magento\Product\Rule\Condition;
...
class Product extends AbstractModel
{
    ...
    private \M2E\Temu\Model\Magento\Product\Rule\Custom\CustomFilterFactory $customFilterFactory;
    private \Magento\Backend\Model\UrlInterface $url;
    private \Magento\Eav\Model\Config $config;
    private \Magento\Eav\Model\ResourceModel\Entity\Attribute\Set\Collection $attrSetCollection;
    ...
    public function __construct(
        ...
        \M2E\Temu\Model\Magento\Product\Rule\Custom\CustomFilterFactory $customFilterFactory,
    ...
    public function getValueElementRenderer()
    {
        ...
        return $this->_layout->getBlockSingleton(
            \M2E\Temu\Block\Adminhtml\Magento\Product\Rule\Renderer\Editable::class
        );
    }
    ...
    protected function _addSpecialAttributes(array &$attributes)
    {
        ...
        foreach ($this->getCustomFilters() as $customFilterClassName) {
            ...
            if ($customFilterInstance instanceof \M2E\Temu\Model\Magento\Product\Rule\Custom\AbstractCustomFilter) {
    ...
    public function getInputType(): string
    {
        if ($this->isFilterCustom($this->getAttribute())) {
            return $this->getCustomFilterInstance($this->getAttribute())
                        ->getInputType();
        }
    ...
    {
        return [
            \M2E\Temu\Model\Magento\Product\Rule\Custom\Magento\Stock::NICK,
            \M2E\Temu\Model\Magento\Product\Rule\Custom\Magento\Qty::NICK,
            \M2E\Temu\Model\Magento\Product\Rule\Custom\Magento\TypeId::NICK,
            \M2E\Temu\Model\Magento\Product\Rule\Custom\Temu\OnlineTitle::NICK,
            \M2E\Temu\Model\Magento\Product\Rule\Custom\Temu\OnlineQty::NICK,
            \M2E\Temu\Model\Magento\Product\Rule\Custom\Temu\OnlinePrice::NICK,
            \M2E\Temu\Model\Magento\Product\Rule\Custom\Temu\Status::NICK,
        ];
    }
    ...
    /**
     * @return \M2E\Temu\Model\Magento\Product\Rule\Custom\AbstractCustomFilter
     * @throws \M2E\Temu\Model\Exception\Logic
     */
    protected function getCustomFilterInstance(
        string $filterType,
        bool $isReadyToCache = true
    ): ?\M2E\Temu\Model\Magento\Product\Rule\Custom\AbstractCustomFilter {
