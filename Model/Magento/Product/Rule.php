...
class Rule extends \M2E\Temu\Model\ActiveRecord\AbstractModel
{
    protected $_form;
    ...
    /** @var \M2E\Temu\Model\Magento\Product\Rule\Condition\CombineFactory */
    ...
    public function loadFromSerialized($serialized)
    {
        ...
        if ($prefix === null) {
            throw new \M2E\Temu\Model\Exception('Prefix must be specified before.');
        }
     ...
     * @return \M2E\Temu\Model\Magento\Product\Rule\Condition\Combine
     * @throws \M2E\Temu\Model\Exception
     */
    ...
    public function isEmpty()
    {
        ...
        foreach ($this->_conditions->getConditionModels() as $model) {
            if ($model instanceof \M2E\Temu\Model\Magento\Product\Rule\Condition\Product) {
    ...
    public function getConditionObj(): \M2E\Temu\Model\Magento\Product\Rule\Condition\AbstractModel
    {
     ...
     *                        ->createBlock('Temu/adminhtml_magento_product_rule')
