...
namespace M2E\Temu\Model\Magento\Quote\Store;
...
class Configurator
{
    ...
    private \M2E\Temu\Model\Magento\Tax\Rule\BuilderFactory $taxRuleFactory;

    public function __construct(
        \M2E\Temu\Model\Magento\Tax\Rule\BuilderFactory $taxRuleFactory,
        \M2E\Temu\Helper\Data\GlobalData $globalDataHelper,
        \M2E\Temu\Model\Magento\Config\Mutable $mutableConfig,
    ...
    public function getShippingTaxClassId()
    {
        ...
        if (
            ...
            return \M2E\Temu\Model\Magento\Product::TAX_CLASS_ID_NONE;
        }
