...
namespace M2E\Temu\Model\MSI\Order;
...
class Reserve
{
    public const EVENT_TYPE_MAGENTO_RESERVATION_PLACED = 'temu_reservation_placed';
    public const EVENT_TYPE_MAGENTO_RESERVATION_RELEASED = 'temu_reservation_released';

    public const M2E_ORDER_OBJECT_TYPE = 'temu_order';
