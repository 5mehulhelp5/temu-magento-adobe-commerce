...
abstract class AbstractModel extends \M2E\Temu\Model\ActiveRecord\AbstractModel
{
    /**
     * The order of the values of log types' constants is important.
     * @see \M2E\Temu\Block\Adminhtml\Log\Grid\LastActions::$actionsSortOrder
     * @see \M2E\Temu\Block\Adminhtml\Log\Listing\Product\View\Grouped\AbstractGrid::_prepareCollection()
     */
    ...
    protected function validateType(int $type): void
    {
        if (!in_array($type, [self::TYPE_INFO, self::TYPE_SUCCESS, self::TYPE_WARNING, self::TYPE_ERROR], true)) {
            throw new \M2E\Temu\Model\Exception\Logic("Type '$type' is not valid.");
        }
    }
}
