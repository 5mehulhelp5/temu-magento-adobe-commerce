...
namespace M2E\Temu\Model\Template;

class Category extends \M2E\Temu\Model\ActiveRecord\AbstractModel
{
    public const CATEGORY_MODE_NONE = 0;
    public const CATEGORY_MODE_TEMU = 1;
    ...
    public const VALUE_MODE_TEMU_RECOMMENDED = 1;
    ...
    {
        parent::_construct();
        $this->_init(\M2E\Temu\Model\ResourceModel\Category\Dictionary::class);
    }
    ...
    {
        $this->cache->removeTagValues('temu_template_category');
