...
class InspectionTaskProvider implements \M2E\Core\Model\ControlPanel\Inspection\TaskProviderInterface
{
    ...
    private array $definitions = [
        [
            ...
            'handler' => \M2E\Temu\Model\ControlPanel\Inspection\Inspector\ExtensionCron::class,
        ],
        [
            ...
            'handler' => \M2E\Temu\Model\ControlPanel\Inspection\Inspector\FilesPermissions::class,
        ],
        [
            ...
            'group' => \M2E\Core\Model\ControlPanel\InspectionTaskDefinition::GROUP_STRUCTURE,
            'execution_speed_group' => \M2E\Core\Model\ControlPanel\InspectionTaskDefinition::EXECUTION_SPEED_FAST,
            'handler' => \M2E\Temu\Model\ControlPanel\Inspection\Inspector\MagentoSettings::class,
        ],
        [
            ...
            'group' => \M2E\Core\Model\ControlPanel\InspectionTaskDefinition::GROUP_GENERAL,
            'execution_speed_group' => \M2E\Core\Model\ControlPanel\InspectionTaskDefinition::EXECUTION_SPEED_FAST,
            'handler' => \M2E\Temu\Model\ControlPanel\Inspection\Inspector\ServerConnection::class,
        ],
        [
            'nick' => 'ShowLoggers',
            'title' => 'Show loggers',
            ...
            'group' => \M2E\Core\Model\ControlPanel\InspectionTaskDefinition::GROUP_STRUCTURE,
            'execution_speed_group' => \M2E\Core\Model\ControlPanel\InspectionTaskDefinition::EXECUTION_SPEED_SLOW,
            'handler' => \M2E\Temu\Model\ControlPanel\Inspection\Inspector\ShowModuleLoggers::class,
        ],
        [
            ...
            'group' => \M2E\Core\Model\ControlPanel\InspectionTaskDefinition::GROUP_STRUCTURE,
            'execution_speed_group' => \M2E\Core\Model\ControlPanel\InspectionTaskDefinition::EXECUTION_SPEED_FAST,
            'handler' => \M2E\Temu\Model\ControlPanel\Inspection\Inspector\ConfigsValidity::class,
        ],
        [
            'nick' => 'FilesValidity',
            ...
            'group' => \M2E\Core\Model\ControlPanel\InspectionTaskDefinition::GROUP_STRUCTURE,
            'execution_speed_group' => \M2E\Core\Model\ControlPanel\InspectionTaskDefinition::EXECUTION_SPEED_FAST,
            'handler' => \M2E\Temu\Model\ControlPanel\Inspection\Inspector\FilesValidity::class,
        ],
        [
            ...
            'group' => \M2E\Core\Model\ControlPanel\InspectionTaskDefinition::GROUP_STRUCTURE,
            'execution_speed_group' => \M2E\Core\Model\ControlPanel\InspectionTaskDefinition::EXECUTION_SPEED_FAST,
            'handler' => \M2E\Temu\Model\ControlPanel\Inspection\Inspector\TablesStructureValidity::class,
        ],
    ];
