...
namespace M2E\Temu\Plugin\Order\Magento\Quote\Model\Quote\Item;

class ToOrderItem extends \M2E\Temu\Plugin\AbstractPlugin
{
    ...
    protected function processConvert($interceptor, \Closure $callback, array $arguments)
    {
        ...
        $this->eventManager->dispatch(
            'm2e_temu_sales_convert_quote_item_to_order_item',
            [
