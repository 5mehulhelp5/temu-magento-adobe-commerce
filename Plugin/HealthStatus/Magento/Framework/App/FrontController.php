...
namespace M2E\Temu\Plugin\HealthStatus\Magento\Framework\App;

use Magento\Framework\Message\MessageInterface;
use M2E\Temu\Model\HealthStatus\Task\Result;

class FrontController extends \M2E\Temu\Plugin\AbstractPlugin
{
    public const MESSAGE_IDENTIFIER = 'temu_health_status_front_controller_message';

    /** @var \Magento\Framework\Message\ManagerInterface */
    private $messageManager;
    private \M2E\Temu\Model\HealthStatus\CurrentStatus $healthStatusCurrentStatus;
    private \M2E\Temu\Model\HealthStatus\Notification\MessageBuilder $notificationMessageBuilder;
    private \M2E\Temu\Model\HealthStatus\Notification\Settings $notificationSettings;

    public function __construct(
        \Magento\Framework\Message\ManagerInterface $messageManager,
        \M2E\Temu\Model\HealthStatus\CurrentStatus $healthStatusCurrentStatus,
        \M2E\Temu\Model\HealthStatus\Notification\MessageBuilder $notificationMessageBuilder,
