...
use M2E\Temu\Model\ResourceModel\Listing\Log as ListingLogResource;
use M2E\Temu\Model\ResourceModel\Log\System as LogSystemResource;
use M2E\Temu\Model\ResourceModel\Synchronization\Log as SynchronizationLogResource;
...
class LogHandler implements \M2E\Core\Model\Setup\InstallHandlerInterface
{
    ...
    {
        $tableName = $this->tablesHelper->getFullName(TablesHelper::TABLE_NAME_LISTING_LOG);
    ...
    {
        $tableName = $this->tablesHelper->getFullName(TablesHelper::TABLE_NAME_ORDER_LOG);
    ...
    {
        $tableName = $this->tablesHelper->getFullName(TablesHelper::TABLE_NAME_SYNCHRONIZATION_LOG);
    ...
    {
        $tableName = $this->tablesHelper->getFullName(TablesHelper::TABLE_NAME_SYSTEM_LOG);
