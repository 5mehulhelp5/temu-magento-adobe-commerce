...
class ProcessingHandler implements \M2E\Core\Model\Setup\InstallHandlerInterface
{
    ...
    {
        $tableName = $this->tablesHelper->getFullName(TablesHelper::TABLE_NAME_PROCESSING);
    ...
    {
        $tableName = $this->tablesHelper->getFullName(TablesHelper::TABLE_NAME_PROCESSING_PARTIAL_DATA);
    ...
    {
        $tableName = $this->tablesHelper->getFullName(TablesHelper::TABLE_NAME_PROCESSING_LOCK);
