...
use M2E\Temu\Model\Listing\Log;
...
class Listing extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\Text
{
    ...
    protected function getAvailableActions(): array
    {
        return [
            ...
            Log::ACTION_REMOVE_PRODUCT => (string)__('Stop on Channel / Remove from Listing'),
    ...
    public function render(\Magento\Framework\DataObject $row)
    {
        ...
        $dbSelect = $connection->select()
                               ...
                               ->order(['id DESC'])
                               ->limit(\M2E\Temu\Block\Adminhtml\Log\Grid\LastActions::PRODUCTS_LIMIT);
    ...
    {
        $summary = $this->getLayout()->createBlock(\M2E\Temu\Block\Adminhtml\Listing\Log\Grid\LastActions::class)
                        ->setData([
