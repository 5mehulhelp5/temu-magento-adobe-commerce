...
namespace M2E\Temu\Block\Adminhtml\Grid\Column\Renderer\ViewLogIcon;
...
class Order extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\Text
{
    ...
    private \M2E\Temu\Model\ResourceModel\Order\Log\CollectionFactory $orderLogCollectionFactory;

    public function __construct(
        \M2E\Temu\Model\ResourceModel\Order\Log\CollectionFactory $orderLogCollectionFactory,
    ...
    public function render(\Magento\Framework\DataObject $row)
    {
        ...
        $orderLogsCollection->getSelect()
                            ->limit(\M2E\Temu\Block\Adminhtml\Log\Grid\LastActions::ACTIONS_COUNT);
        ...
        $summary = $this->getLayout()->createBlock(\M2E\Temu\Block\Adminhtml\Order\Log\Grid\LastActions::class)
                        ->setData([
                            'entity_id' => $orderId,
