...
namespace M2E\Temu\Block\Adminhtml\Magento\Payment;
...
class Info extends \Magento\Payment\Block\Info
{
    ...
    protected $_template = 'M2E_Temu::magento/order/payment/info.phtml';
    ...
    public function getPaymentMethod(): string
    {
        return (string)$this
            ->getInfo()
            ->getAdditionalInformation(TemuPayment::ADDITIONAL_DATA_KEY_PAYMENT_METHOD);
    }
    ...
    public function getChannelOrderId(): string
    {
        return (string)$this
            ->getInfo()
            ->getAdditionalInformation(TemuPayment::ADDITIONAL_DATA_KEY_CHANNEL_ORDER_ID);
    }
}
