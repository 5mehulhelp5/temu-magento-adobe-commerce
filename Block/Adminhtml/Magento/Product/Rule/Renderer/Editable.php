...
namespace M2E\Temu\Block\Adminhtml\Magento\Product\Rule\Renderer;

use M2E\Temu\Block\Adminhtml\Magento\AbstractBlock;
use Magento\Framework\Data\Form\Element\AbstractElement;

/**
 * Class \M2E\Temu\Block\Adminhtml\Magento\Product\Rule\Renderer\Editable
 */
        ...
        if ($element->getShowAsText()) {
            ...
            if ($element->getExplicitApply()) {
                $html .= ' <a href="javascript:void(0)" class="rule-param-apply"><img src="'
                    . $this->_assetRepo->getUrl('images/rule_component_apply.gif')
                    . '" class="v-middle" alt="'
