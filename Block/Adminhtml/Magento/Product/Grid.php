...
namespace M2E\Temu\Block\Adminhtml\Magento\Product;

abstract class Grid extends \M2E\Temu\Block\Adminhtml\Magento\Grid\AbstractGrid
{
    ...
    public function setCollection($collection)
    {
        ...
        /** @var \M2E\Temu\Model\Magento\Product\Rule $ruleModel */
...
CSS
    ...
    public function getMassactionBlockHtml()
    {
        ...
        $advancedFilterBlock = $this
            ->getLayout()
            ->createBlock(\M2E\Temu\Block\Adminhtml\Listing\Product\Rule::class);
...
JS
        ...
        $this->jsTranslator->addTranslations([
            'Please select the Products you want to perform the Action on.' => \M2E\Core\Helper\Data::escapeJs(
                __('Please select the Products you want to perform the Action on.')->__toString()
            ),
