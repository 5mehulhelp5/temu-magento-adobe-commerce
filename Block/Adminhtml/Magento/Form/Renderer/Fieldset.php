...
class Fieldset extends MagentoFieldset
{
    ...
    {
        return <<<HTML
<div class="Temu-field-tooltip Temu-field-tooltip-{$directionClass}
Temu-fieldset-tooltip admin__field-tooltip">
...
HTML;
    ...
    {
        $element->addClass('Temu-fieldset');
        ...
        $element->addField(
            ...
            \M2E\Temu\Block\Adminhtml\Magento\Form\AbstractForm::HELP_BLOCK,
            [
                'content' => $tooltip,
                'tooltiped' => true,
            ],
