...
namespace M2E\Temu\Block\Adminhtml\Magento\Grid\Column\Filter;

/**
 * Class \M2E\Temu\Block\Adminhtml\Magento\Grid\Column\Filter\AttributesOptions
 */
class AttributesOptions extends \Magento\Backend\Block\Widget\Grid\Column\Filter\Select
{
    ...
    {
        $src = $this->getViewFileUrl('images/rule_component_remove.gif');
