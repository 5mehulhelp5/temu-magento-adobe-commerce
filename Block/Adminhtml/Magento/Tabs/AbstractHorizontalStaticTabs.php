...
abstract class AbstractHorizontalStaticTabs extends \M2E\Temu\Block\Adminhtml\Magento\AbstractBlock
{
    ...
    protected $_template = 'M2E_Temu::magento/tabs/horizontal_static.phtml';
    ...
    protected function _toHtml()
    {
        ...
        if (!empty($styles)) {
            $this->css->add('.Temu-tabs-horizontal-static{ ' . $styles . ' }');
        }
