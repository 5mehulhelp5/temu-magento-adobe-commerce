...
class AttributeMapping extends \M2E\Temu\Block\Adminhtml\Magento\Form\AbstractForm
{
    /** @var \M2E\Temu\Block\Adminhtml\Settings\Tabs\AttributeMapping\GpsrAttributesFieldsetFill */
    ...
    protected function _beforeToHtml()
    {
        $this->jsUrl->add(
            ...
            \M2E\Temu\Block\Adminhtml\Settings\Tabs::TAB_ID_MAPPING_ATTRIBUTES
        );
    ...
    private function addGpsrAttributesFieldset(\Magento\Framework\Data\Form $form): void
    {
        $fieldset = $form->addFieldset(
            ...
            [
                ...
                Magento attributes and Temu attributes for the GPSR (General Product Safety Regulation) fields.
                By setting these mappings, you can automatically apply the appropriate attributes to all
                Temu categories that require GPSR, simplifying the listing process and ensuring consistency across your products.'),
                'collapsable' => true,
            ]
        );
