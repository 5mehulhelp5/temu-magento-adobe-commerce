...
namespace M2E\Temu\Block\Adminhtml\Log\Listing\Product\View\Grouped;
...
class Grid extends \M2E\Temu\Block\Adminhtml\Log\Listing\Product\AbstractGrid
{
    ...
    protected function _afterLoadCollection()
    {
        ...
        $sortOrder = \M2E\Temu\Block\Adminhtml\Log\Grid\LastActions::$actionsSortOrder;
    ...
    public function callbackColumnDescription($value, $row, $column, $isExport)
    {
        ...
        /** @var \M2E\Temu\Model\Listing\Log $log */
