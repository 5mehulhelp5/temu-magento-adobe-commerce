...
use M2E\Temu\Model\HealthStatus\Notification\Settings;
use M2E\Temu\Model\HealthStatus\Task\Result;

class Notifications extends \M2E\Temu\Block\Adminhtml\Magento\Form\AbstractForm
{
    ...
    protected function _prepareForm()
    {
        ...
        $form->addField(
            ...
            [
                'content' => __(
                    'You can specify how %extension_title should notify you about Health Status of ' .
                    'your %extension_title by selecting: <ul>' .
                    '<li><b>Do Not Notify</b> - no notification required;</li>' .
                    '<li><b>On each Extension Page (default)</b> - notification will be shown on each ' .
                    'page of %extension_title Module;</li>' .
    ...
    protected function _beforeToHtml()
    {
        ...
        $this->jsPhp->addConstants(
            [
                '\M2E\Temu\Model\HealthStatus\Notification\Settings::MODE_EMAIL' => \M2E\Temu\Model\HealthStatus\Notification\Settings::MODE_EMAIL,
            ]
        );

        $this->js->addRequireJs(
            ['hS' => 'Temu/HealthStatus'],
            <<<JS
