...
namespace M2E\Temu\Block\Adminhtml\Tag;
...
class Switcher extends \M2E\Temu\Block\Adminhtml\Switcher
{
    ...
    private \M2E\Temu\Model\Tag\ListingProduct\Repository $tagRelationRepository;
    private string $label;

    public function __construct(
        string $label,
        string $controllerName,
        \M2E\Temu\Model\Tag\ListingProduct\Repository $tagRelationRepository,
