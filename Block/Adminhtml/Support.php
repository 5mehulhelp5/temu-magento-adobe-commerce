...
class Support extends \M2E\Temu\Block\Adminhtml\Magento\AbstractBlock
{
    private \M2E\Temu\Helper\Module\Support $moduleSupportHelper;

    public function __construct(
        \M2E\Temu\Helper\Module\Support $moduleSupportHelper,
        ...
        $this->appendHelpBlock([
            ...
            'content' => __(
                ...
                [
                    ...
                    'docs_url' => 'https://docs-m2.m2epro.com/docs-category/temu-magento-adobe-commerce-integration/',
                    'helpdesk_url' => 'https://help.m2epro.com/en/support/solutions/9000117126',
                    'youtube_url' => 'https://www.youtube.com/watch?v=tka24gn22oQ',
                ]
            ),
        ]);
...
<div class="a-center">
    <input id="contact_us_button"
        value="Contact Us"
        class="action-primary Temu-field-without-tooltip"
        type="button"
