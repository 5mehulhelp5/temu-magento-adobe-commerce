...
namespace M2E\Temu\Block\Adminhtml\Order\Item\Product\Options;
...
class Mapping extends AbstractContainer
{
    ...
    public function getOrderItem(): \M2E\Temu\Model\Order\Item
    {
    ...
    protected function _beforeToHtml()
    {
        ...
        if ($this->magentoProduct->isGroupedType()) {
            $magentoOptionLabel = __(
                \M2E\Temu\Model\Magento\Product\Variation::GROUPED_PRODUCT_ATTRIBUTE_LABEL
            );
        ...
        $this->setChild(
            ...
            $this->getLayout()->createBlock(\M2E\Temu\Block\Adminhtml\HelpBlock::class)->setData([
                'content' => __(
