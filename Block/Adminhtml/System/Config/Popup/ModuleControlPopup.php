...
namespace M2E\Temu\Block\Adminhtml\System\Config\Popup;

class ModuleControlPopup extends \M2E\Temu\Block\Adminhtml\Magento\AbstractBlock
{
    /** @var \M2E\Temu\Helper\Module */
    protected $moduleHelper;

    /**
     * @param \M2E\Temu\Block\Adminhtml\Magento\Context\Template $context
     * @param \M2E\Temu\Helper\Module $moduleHelper
     * @param array $data
     */
...
HTML;
    ...
    protected function _prepareLayout()
    {
        ...
        $this->js->addRequireJs(
            ...
            <<<JS
toggleTemuModuleStatus = function () {
