...
namespace M2E\Temu\Block\Adminhtml\System\Config\Sections;

class InterfaceAndMagentoInventory extends \M2E\Temu\Block\Adminhtml\System\Config\Sections
{
    /** @var \M2E\Temu\Model\Module\Configuration */
    private $configurationHelper;
    private \M2E\Temu\Model\Product\InspectDirectChanges\Config $inspectDirectChangesConfig;

    public function __construct(
        \M2E\Temu\Model\Product\InspectDirectChanges\Config $inspectDirectChangesConfig,
        \M2E\Temu\Model\Module\Configuration $configurationHelper,
    ...
    protected function _prepareForm()
    {
        ...
        $form->addField(
            ...
            [
                ...
                'no_hide' => true,
                'content' => __(
                    '<p>Here you can provide global settings for the Module Interface, ' .
                    ...
                    ['url' => 'https://docs-m2.m2epro.com/docs/m2e-temu-global-settings/'],
                ),
            ]
        );
        ...
        $fieldset->addField(
            ...
            [
                ...
                'tooltip' => __('Choose whether you want to see Thumbnail Images for ' .
                    'Products on the Add Products and View Listing Pages.'),
            ]
        );
        ...
        $fieldset->addField(
            ...
            [
                ...
                'tooltip' => __('Set a number to List, e.g. if you have Manage Stock "No" in Magento Product ' .
                    'and set this Value to 10, 10 will be sent as available Quantity to the Channel.'),
    ...
    protected function _prepareLayout()
    {
        ...
        $this->jsUrl->add(
            $this->getUrl('m2e_temu/settings_interfaceAndMagentoInventory/restoreRememberedChoices'),
