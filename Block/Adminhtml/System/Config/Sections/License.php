...
class License extends \M2E\Temu\Block\Adminhtml\System\Config\Sections
{
    ...
    protected function _prepareLayout()
    {
        ...
        $jsSettings = json_encode(
            [
                'change' => $this->getUrl('m2e_temu/settings_license/change'),
                'refresh' => $this->getUrl('m2e_temu/settings_license/refreshStatus'),
                'licenseSection' => $this->getUrl('m2e_temu/settings_license/section'),
            ]
        );
        $this->js->addRequireJs(
            [
                'l' => 'Temu/Settings/License',
            ],
            <<<JS
