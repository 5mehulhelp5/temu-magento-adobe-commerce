...
{
    protected $_template = 'template/selling_format/price_table.phtml';
    ...
    protected function _beforeToHtml()
    {
        ...
        $buttonBlock = $this->getLayout()->createBlock(\M2E\Temu\Block\Adminhtml\Magento\Button::class)
                            ->setData([
                                ...
                                'onclick' => 'TemuTemplateSellingFormatObj.addFixedPriceChangeRow();',
    ...
    {
        return $this->globalDataHelper->getValue('temu_attributes');
    }
}
