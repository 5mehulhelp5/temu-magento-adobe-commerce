...
class PriceChange extends \M2E\Temu\Block\Adminhtml\Magento\AbstractBlock
{
    /** @var string */
    ...
    public function getPriceModifierAttributes(string $priceModifierString): array
    {
        ...
        foreach ($priceModifier as $modification) {
            if (
                $modification['mode'] == \M2E\Temu\Model\Policy\SellingFormat::PRICE_MODIFIER_ATTRIBUTE
