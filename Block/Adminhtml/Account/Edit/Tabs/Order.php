...
for an item that does <b>not</b> belong to the %extension_title Listing.',
        ...
        $none = [
            'value' => \M2E\Temu\Model\Magento\Product::TAX_CLASS_ID_NONE,
            'label' => __('None'),
        ];
        ...
        $fieldset = $form->addFieldset(
            'magento_block_temu_accounts_magento_orders_number',
            [
        ...
        $fieldset->addField(
            ...
            [
                ...
                'values' => [
                    ...
                    OrderSettings::NUMBER_SOURCE_CHANNEL => __(\M2E\Temu\Helper\Module::getChannelTitle()),
                ],
        ...
        $shipByDateFieldset = $form->addFieldset(
            'magento_block_temu_accounts_magento_orders_shipping_information',
            [
        ...
        $fieldset = $form->addFieldset(
            'magento_block_temu_accounts_magento_orders_customer',
            [
        ...
        $fieldset->addField(
            ...
            [
                ...
                'class' => 'validate-digits Temu-account-customer-id',
        ...
        $fieldset = $form->addFieldset(
            'magento_block_temu_accounts_magento_orders_rules',
            [
        ...
        $fieldset = $form->addFieldset(
            'magento_block_temu_accounts_magento_orders_cancellation',
            [
                'legend' => __('Cancellation'),
                'collapsable' => true,
            ]
        );
        ...
        $fieldset = $form->addFieldset(
            'magento_block_temu_accounts_magento_orders_tax',
            [
        ...
        $fieldset->addField(
            ...
            [
                ...
                'values' => [
                    ...
                    OrderSettings::TAX_MODE_CHANNEL => __(\M2E\Temu\Helper\Module::getChannelTitle()),
                    OrderSettings::TAX_MODE_MAGENTO => __('Magento'),
                    OrderSettings::TAX_MODE_MIXED => __(\M2E\Temu\Helper\Module::getChannelTitle() . ' & Magento'),
                ],
        ...
        //region Order Mapping Settings
        $fieldset = $form->addFieldset(
            'magento_block_temu_accounts_magento_orders_status_mapping',
            [
        ...
        $fieldset->addField(
            ...
            [
                ...
                'values' => [
                    \M2E\Temu\Model\Account\Settings\Order::ORDERS_STATUS_MAPPING_MODE_DEFAULT => __('Default Order Statuses'),
                    \M2E\Temu\Model\Account\Settings\Order::ORDERS_STATUS_MAPPING_MODE_CUSTOM => __('Custom Order Statuses'),
                ],
