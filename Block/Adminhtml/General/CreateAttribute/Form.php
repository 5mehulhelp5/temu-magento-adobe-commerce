...
namespace M2E\Temu\Block\Adminhtml\General\CreateAttribute;

use M2E\Temu\Block\Adminhtml\Magento\Form\AbstractForm;
use M2E\Temu\Model\Magento\Attribute\Builder as AttributeBuilder;
...
class Form extends AbstractForm
{
    ...
    protected function _prepareForm()
    {
        ...
        $form->addField(
            ...
            self::HELP_BLOCK,
            [
                'content' => __('This Tool allows you to quickly <strong>Create</strong> ' .
                    'a new <strong>Magento Attribute</strong> for the selected Option. In order to ' .
                    'Create an Attribute, you have to fill in the Attribute Label, Attribute Code, Catalog ' .
                    'Input Type, Scope, Default Value and Attribute Sets fields.<br/><br/>' .
                    '<strong>Note:</strong> Some of the fields may not be available for selection. ' .
                    'The availability depends on the Option for which the Attribute is being created.<br/>' .
                    '<strong>Note:</strong> This Option does not imply automatic Product Attribute Value set up. ' .
                    'After the Attribute becomes available in Magento, you should Manually provide ' .
        ...
        $classes = 'validate-length maximum-length-30 Temu-validate-attribute-code ';
        $classes .= 'Temu-validate-attribute-code-to-be-unique';
    ...
    protected function _toHtml()
    {
        $this->jsTranslator->addTranslations([
            'Invalid attribute code' => __('Please use only letters (a-z), numbers (0-9) or ' .
        ...
        jQuery.validator.addMethod('Temu-validate-attribute-code', function(value, element) {
            return handler.validateAttributeCode(value, element);
        }, Temu.translator.translate('Invalid attribute code'));

        jQuery.validator.addMethod('Temu-validate-attribute-code-to-be-unique', function(value, element) {
            return handler.validateAttributeCodeToBeUnique(value, element);
        }, Temu.translator.translate('Attribute with the same code already exists'));
JS
        );
