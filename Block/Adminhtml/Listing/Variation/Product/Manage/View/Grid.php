...
class Grid extends \M2E\Temu\Block\Adminhtml\Magento\Grid\AbstractGrid
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->joinTable(
            ...
            sprintf(
                '%s = entity_id',
                \M2E\Temu\Model\ResourceModel\Product\VariantSku::COLUMN_MAGENTO_PRODUCT_ID
            ),
            [
                'id' => \M2E\Temu\Model\ResourceModel\Product\VariantSku::COLUMN_ID,
                'variant_status' => \M2E\Temu\Model\ResourceModel\Product\VariantSku::COLUMN_STATUS,
                'product_id' => \M2E\Temu\Model\ResourceModel\Product\VariantSku::COLUMN_PRODUCT_ID,
                'magento_product_id' => \M2E\Temu\Model\ResourceModel\Product\VariantSku::COLUMN_MAGENTO_PRODUCT_ID,
                'sku_id' => \M2E\Temu\Model\ResourceModel\Product\VariantSku::COLUMN_SKU_ID,
                'online_sku' => \M2E\Temu\Model\ResourceModel\Product\VariantSku::COLUMN_ONLINE_SKU,
                'online_price' => \M2E\Temu\Model\ResourceModel\Product\VariantSku::COLUMN_ONLINE_PRICE,
                'online_qty' => \M2E\Temu\Model\ResourceModel\Product\VariantSku::COLUMN_ONLINE_QTY,
            ]
        );
