...
namespace M2E\Temu\Block\Adminhtml\Listing\Wizard\Product;

class Add extends \M2E\Temu\Block\Adminhtml\Magento\Grid\AbstractContainer
{
    ...
    private function addGrid(): void
    {
        switch ($this->sourceMode) {
            case \M2E\Temu\Block\Adminhtml\Listing\Wizard\ProductSourceSelect::MODE_PRODUCT:
                $gridClass = \M2E\Temu\Block\Adminhtml\Listing\Wizard\Product\Add\Grid::class;
                break;

            case \M2E\Temu\Block\Adminhtml\Listing\Wizard\ProductSourceSelect::MODE_CATEGORY:
                $gridClass = \M2E\Temu\Block\Adminhtml\Listing\Wizard\Product\Add\Category\Grid::class;
                break;

            default:
                throw new \M2E\Temu\Model\Exception\Logic(sprintf('Unknown source mode - %s', $this->sourceMode));
        }
