...
namespace M2E\Temu\Block\Adminhtml\Listing\Wizard\Category\ModeManually;

use M2E\Temu\Block\Adminhtml\Order\Grid\Column\Filter\CategoryMode as CategoryModeFilter;
use M2E\Temu\Model\ResourceModel\Listing\Wizard\Step as StepResource;
...
class Grid extends \M2E\Temu\Block\Adminhtml\Magento\Grid\AbstractGrid
{
    ...
    private \M2E\Temu\Model\ResourceModel\Listing\Wizard\Product $productResource;
    ...
    public function __construct(
        ...
        \M2E\Temu\Model\ResourceModel\Listing\Wizard\Product $productResource,
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->joinTable(
            ...
            sprintf(
                '%s = entity_id',
                \M2E\Temu\Model\ResourceModel\Listing\Wizard\Product::COLUMN_MAGENTO_PRODUCT_ID,
            ),
            [
                'product_id' => \M2E\Temu\Model\ResourceModel\Listing\Wizard\Product::COLUMN_ID,
            ],
            sprintf(
                '{{table}}.%s = %s',
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('category', [
            'header' => __(\M2E\Temu\Helper\Module::getChannelTitle() . ' Category'),
            'align' => 'left',
            'width' => '*',
            'index' => 'category',
            'type' => 'options',
...
require([
    ...
    'Temu/Listing/Wizard/Category/Mode/Manually/Grid'
], function(){
