...
class ProductSourceSelect extends \M2E\Temu\Block\Adminhtml\Magento\Form\AbstractContainer
{
    use WizardTrait;
    ...
    {
        $this->addChild('form', \M2E\Temu\Block\Adminhtml\Listing\Wizard\ProductSource\Form::class);
