...
class CategorySelectMode extends \M2E\Temu\Block\Adminhtml\Magento\Form\AbstractContainer
{
    use WizardTrait;
    ...
    {
        $this->addChild('form', \M2E\Temu\Block\Adminhtml\Listing\Wizard\Category\ModeSame\Form::class);
