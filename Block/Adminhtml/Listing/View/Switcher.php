...
{
    public const VIEW_MODE_CHANNEL = 'temu';
    ...
    protected \M2E\Temu\Helper\Data\Session $sessionDataHelper;
    ...
    public function getDefaultParam()
    {
        $sessionViewMode = $this->sessionDataHelper->getValue(
            "Temu_listing_{$this->getListing()->getId()}_view_mode"
        );
    ...
    protected function loadItems(): void
    {
        $this->items = [
            'mode' => [
                'value' => [
                    [
                        'value' => self::VIEW_MODE_CHANNEL,
                        'label' => (string)__('Temu'),
                    ],
                    [
