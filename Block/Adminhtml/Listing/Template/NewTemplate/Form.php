...
namespace M2E\Temu\Block\Adminhtml\Listing\Template\NewTemplate;
...
class Form extends \M2E\Temu\Block\Adminhtml\Magento\Form\AbstractForm
{
    protected function _prepareForm()
    {
        if ($this->getData('nick') == '') {
            throw new \M2E\Temu\Model\Exception\Logic('You should set template "nick"');
        }
            ...
            [
                'content' => __(
                    ...
                    [
                        ...
                        'url' => 'https://docs-m2.m2epro.com/docs/m2e-temu-policies/',
                    ]
                ),
            ]
        );
        ...
        $fieldset->addField(
            ...
            [
                ...
                'class' => 'Temu-validate-template-title',
                'label' => __('Title'),
