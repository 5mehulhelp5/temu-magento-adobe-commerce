...
namespace M2E\Temu\Block\Adminhtml\Synchronization\Log;

class Grid extends \M2E\Temu\Block\Adminhtml\Log\AbstractGrid
{
    private array $actionsTitles = [];
    private \M2E\Temu\Model\ResourceModel\Synchronization\Log\CollectionFactory $syncLogCollectionFactory;

    public function __construct(
        \M2E\Temu\Model\ResourceModel\Synchronization\Log\CollectionFactory $syncLogCollectionFactory,
    ...
    public function _construct()
    {
        ...
        $this->setId('synchronizationLogGrid' . $task . 'Temu');
        ...
        $this->actionsTitles = \M2E\Temu\Helper\Module\Log::getActionsTitlesByClass(
    ...
    protected function _getLogTypeList(): array
    {
        return [
            ...
            \M2E\Temu\Model\Synchronization\Log::TYPE_FATAL_ERROR => (string)__('Fatal Error'),
        ];
    }
    ...
    /**
     * @param \M2E\Temu\Model\ResourceModel\Synchronization\Log\Collection $collection
    ...
    protected function callbackFilterTask($collection, $column): void
    {
        ...
        if ((int)$taskCode === \M2E\Temu\Model\Synchronization\Log::TASK_ALL) {
            return;
        }

        $collection->addFieldToFilter(
            \M2E\Temu\Model\ResourceModel\Synchronization\Log::COLUMN_TASK,
            ['eq' => (int)$taskCode]
        );
    }
