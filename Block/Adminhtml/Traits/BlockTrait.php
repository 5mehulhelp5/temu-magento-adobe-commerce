...
trait BlockTrait
{
    ...
    {
        $directionToRightClass = $directionToRight ? 'Temu-field-tooltip-right' : '';

        return <<<HTML
<div class="Temu-field-tooltip admin__field-tooltip {$directionToRightClass}">
...
HTML;
    ...
    {
        return $this->getLayout()->addBlock(\M2E\Temu\Block\Adminhtml\HelpBlock::class, '', 'main.top')
                    ->setData(
                        $data,
                    );
    }
