    ...
    window.BlockNotice = Class.create(Common, {
        ...
        shrinkTitledContent: function (id, storage) {
            ...
            block.find('.content').animate({
                ...
                block.find('.title a').attr('onclick', onclick);
                block.find('.title a').attr('title', Temu.translator.translate('Expand'));
        ...
        expandTitledContent: function (id, storage) {
            ...
            block.find('.content').animate({
                ...
                onclick = onclick.replace(/expandTitledContent/, 'shrinkTitledContent');
                block.find('.title a').attr('onclick', onclick);
                block.find('.title a').attr('title', Temu.translator.translate('Collapse'));
        ...
        hideFieldsetIcon: function (id) {
            ...
            jQuery('#' + fieldsetId + '-wrapper').find('.Temu-fieldset-tooltip').hide();
        },
        ...
        init: function (reinit) {
            ...
            const blockNotices = jQuery('.block_notices');
            ...
            blockNotices.each(function (index, block) {
                ...
                const noCollapse = jQuery(block).hasClass('no_collapse');
                ...
                const wasShown = self.getHashedStorage(id + self.storageKeys.shown);
                const tooltiped = jQuery(block).hasClass('tooltiped');
                const expanded = self.getHashedStorage(id + self.storageKeys.expandedContent);
                const closed = self.getHashedStorage(id + self.storageKeys.closed);
