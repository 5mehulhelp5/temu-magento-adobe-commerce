    ...
    window.ListingWizardProductAdd = Class.create(Common, {
        ...
        continue: function () {
            ...
            self.options.get_selected_products(function (selectedProducts) {
                ...
                if (!selectedProducts) {
                    self.alert(Temu.translator.translate('Please select the Products you want to perform the Action on.'));
                    return;
                }
        ...
        sendPartsProducts: function (parts, partsCount) {
            ...
            new Ajax.Request(Temu.url.get('listing_wizard_product_add_with_id'), {
                method: 'post',
                parameters: {
                    products: partString,
                },
                onSuccess: function (transport) {
                    ...
                    if (percents <= 0) {
                        ...
                        setLocation(Temu.url.get('listing_wizard_product_complete_with_id'));
                    } else {
