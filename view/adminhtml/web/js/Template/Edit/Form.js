define([
        ...
        function (jQuery) {
            ...
            window.TemuTemplateEdit = Class.create(TemplateEdit, {
                ...
                initialize: function () {
                    jQuery.validator.addMethod('validate-title-uniqueness', function (value) {
                        ...
                        if ($(TemuTemplateEditObj.templateNick + '_id')) {
                            templateId = $(TemuTemplateEditObj.templateNick + '_id').value;
                        }
                        ...
                        return unique;
                    }, Temu.translator.translate('Policy Title is not unique.'));
                },
                ...
                isValidForm: function () {
                    ...
                    var titleInput = $$('input[name="' + TemuTemplateEditObj.templateNick + '[title]"]')[0];
