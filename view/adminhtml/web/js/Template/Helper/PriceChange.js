define([
    ...
    window.TemplateHelperPriceChange = Class.create(Common, {
        ...
        constAbsoluteIncrease: Temu.php.constant(
                '\\M2E\\Temu\\Model\\Policy\\SellingFormat::PRICE_MODIFIER_ABSOLUTE_INCREASE'
        ),
        constAbsoluteDecrease: Temu.php.constant(
                '\\M2E\\Temu\\Model\\Policy\\SellingFormat::PRICE_MODIFIER_ABSOLUTE_DECREASE'
        ),
        constPercentageIncrease: Temu.php.constant(
                '\\M2E\\Temu\\Model\\Policy\\SellingFormat::PRICE_MODIFIER_PERCENTAGE_INCREASE'
        ),
        constPercentageDecrease: Temu.php.constant(
                '\\M2E\\Temu\\Model\\Policy\\SellingFormat::PRICE_MODIFIER_PERCENTAGE_DECREASE'
        ),
        constAttribute: Temu.php.constant(
                '\\M2E\\Temu\\Model\\Policy\\SellingFormat::PRICE_MODIFIER_ATTRIBUTE'
        ),
