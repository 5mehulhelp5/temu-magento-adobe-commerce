        ...
        advancedFilterToggle: function () {
            ...
            if (jQuery('#listing_product_rules:visible').length) {
                ...
                if ($$('#advanced_filter_button span span span').length > 0) {
                    $$('#advanced_filter_button span span span')[0].innerHTML = Temu.translator.translate('Show Advanced Filter');
                } else {
                    $$('#advanced_filter_button span')[0].innerHTML = Temu.translator.translate('Show Advanced Filter');
                }
            } else {
                ...
                if ($$('#advanced_filter_button span span span').length > 0) {
                    $$('#advanced_filter_button span span span')[0].innerHTML = Temu.translator.translate('Hide Advanced Filter');
                } else {
                    $$('#advanced_filter_button span')[0].innerHTML = Temu.translator.translate('Hide Advanced Filter');
                }
            }
        },
