...
class Log
{
    ...
    {
        switch ($class) {
            case \M2E\Temu\Model\Listing\Log::class:
                $prefix = 'ACTION_';
                break;

            case \M2E\Temu\Model\Synchronization\Log::class:
                $prefix = 'TASK_';
                break;
        }
    ...
    {
        $typesStatusesMap = [
            \M2E\Temu\Model\Log\AbstractModel::TYPE_INFO => \M2E\Core\Helper\Data::STATUS_SUCCESS,
            \M2E\Temu\Model\Log\AbstractModel::TYPE_SUCCESS => \M2E\Core\Helper\Data::STATUS_SUCCESS,
            \M2E\Temu\Model\Log\AbstractModel::TYPE_WARNING => \M2E\Core\Helper\Data::STATUS_WARNING,
            \M2E\Temu\Model\Log\AbstractModel::TYPE_ERROR => \M2E\Core\Helper\Data::STATUS_ERROR,
        ];
...
DATA;
    ...
    {
        $moduleInfo = [];
        $moduleInfo['name'] = $this->objectManager->get(\M2E\Temu\Model\Module::class)->getName();
        $moduleInfo['version'] = $this->objectManager->get(\M2E\Temu\Model\Module::class)->getPublicVersion();
