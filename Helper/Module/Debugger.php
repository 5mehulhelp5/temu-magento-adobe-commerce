...
class Debugger
{
    ...
    private static \M2E\Temu\Helper\Module\Logger $logger;
    ...
    private static function getLogger(): \M2E\Temu\Helper\Module\Logger
    {
        /** @psalm-suppress RedundantPropertyInitializationCheck */
        if (!isset(self::$logger)) {
            self::$logger = \Magento\Framework\App\ObjectManager::getInstance()
                                                                ->get(\M2E\Temu\Helper\Module\Logger::class);
        }
