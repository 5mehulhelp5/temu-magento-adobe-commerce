...
/*
    ...
    $model = $this->_objectManager->create('\M2E\Temu\PublicServices\Product\SqlChange');
...
class SqlChange
{
    ...
    /**
     * @return \M2E\Temu\PublicServices\Product\SqlChange
    ...
    public function markProductAttributeChanged(
        ...
        throw new \M2E\Temu\Model\Exception\Logic('Method is not supported.');
    }
