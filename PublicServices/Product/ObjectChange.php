...
/*
    ...
    $model = $this->_objectManager->create('\M2E\Temu\PublicServices\Product\ObjectChange');
...
namespace M2E\Temu\PublicServices\Product;
...
class ObjectChange
{
    ...
    /** @var \M2E\Temu\Observer\Product\AddUpdate\BeforeFactory */
    private $observerProductSaveBeforeFactory;
    /** @var \M2E\Temu\Observer\Product\AddUpdate\AfterFactory */
    private $observerProductSaveAfterFactory;
    /** @var \M2E\Temu\Observer\StockItem\Save\BeforeFactory */
    private $observerStockItemSaveBeforeFactory;
    /** @var \M2E\Temu\Observer\StockItem\Save\AfterFactory */
    ...
    public function __construct(
        ...
        \M2E\Temu\Observer\Product\AddUpdate\BeforeFactory $observerProductSaveBeforeFactory,
        \M2E\Temu\Observer\Product\AddUpdate\AfterFactory $observerProductSaveAfterFactory,
        \M2E\Temu\Observer\StockItem\Save\BeforeFactory $observerStockItemSaveBeforeFactory,
        \M2E\Temu\Observer\StockItem\Save\AfterFactory $observerStockItemSaveAfterFactory,
        SqlChange $sqlChange,
