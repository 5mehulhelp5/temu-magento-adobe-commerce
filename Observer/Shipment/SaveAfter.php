...
namespace M2E\Temu\Observer\Shipment;

class SaveAfter extends \M2E\Temu\Observer\AbstractObserver
{
    private \M2E\Temu\Model\Order\Repository $orderRepository;
    private \M2E\Temu\Observer\Shipment\EventRuntimeManager $eventRuntimeManager;
    private \M2E\Temu\Model\Order\ShipmentService $shipmentHandler;

    public function __construct(
        \M2E\Temu\Observer\Shipment\EventRuntimeManager $eventRuntimeManager,
        \M2E\Temu\Model\Order\Repository $orderRepository,
        \M2E\Temu\Model\Order\ShipmentService $shipmentHandler
    ) {
