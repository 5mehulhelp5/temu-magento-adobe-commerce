...
namespace M2E\Temu\Observer\Order;

class Quote extends \M2E\Temu\Observer\AbstractObserver
{
    ...
    public function beforeProcess(): void
    {
        ...
        if (!($product instanceof \Magento\Catalog\Model\Product) || $product->getId() <= 0) {
            throw new \M2E\Temu\Model\Exception('Product ID should be greater than 0.');
        }
    ...
    private function getMagentoProduct(): \Magento\Catalog\Model\Product
    {
        if (!($this->product instanceof \Magento\Catalog\Model\Product)) {
            throw new \M2E\Temu\Model\Exception\Logic('Property "Product" should be set first.');
        }
    ...
    private function getAffectedProductCollection(): \M2E\Temu\Model\Product\AffectedProduct\Collection
    {
        ...
        return $this->affectedProductCollection = $this
            ...
            ->getProductsByMagentoProductId($this->getMagentoProduct()->getId());
    }
