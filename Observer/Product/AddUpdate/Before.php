...
{
    public const BEFORE_EVENT_KEY = 'm2e_temu_before_event_key';

    private \M2E\Temu\Observer\Product\AddUpdate\Before\ProxyFactory $proxyFactory;
    ...
    private function getProxy(): \M2E\Temu\Observer\Product\AddUpdate\Before\Proxy
    {
        if ($this->proxy !== null) {
            return $this->proxy;
        }
