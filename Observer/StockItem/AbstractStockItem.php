...
namespace M2E\Temu\Observer\StockItem;

abstract class AbstractStockItem extends \M2E\Temu\Observer\AbstractObserver
{
    ...
    public function beforeProcess(): void
    {
        ...
        if (!($stockItem instanceof \Magento\CatalogInventory\Api\Data\StockItemInterface)) {
            throw new \M2E\Temu\Model\Exception('StockItem event doesn\'t have correct StockItem instance.');
        }
    ...
    protected function getStockItem(): \Magento\CatalogInventory\Api\Data\StockItemInterface
    {
        ...
        if (!isset($this->stockItem)) {
            throw new \M2E\Temu\Model\Exception\Logic('Property "StockItem" should be set first.');
        }
